<script src="{{asset('default/vendors/jquery/jquery.min.js')}}"></script>
        ...
        <img src="{{asset('Kode Jiwa - Logo.png')}}" width="125" height="90">   
                ...
                <button class="navbar-toggler text-uppercase font-weight-bold bg-primary text-white rounded btn-3d" type="button" data-bs-toggle="collapse" id="collapse" data-bs-target="#navbarResponsive" >
                    Menu
