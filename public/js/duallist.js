...
;(function ($, window, document, undefined) {
 ...
 var demo1 = $('select[name="multiprovinsi[]"]').bootstrapDualListbox({
    nonSelectedListLabel: 'Pilih Provinsi',
    selectedListLabel: 'Provinsi Terpilih',
    preserveSelectionOnMove: 'moved',
    moveAllLabel: 'Move all',
    removeAllLabel: 'Remove all'
  });
  $("#demoformprovinsi").submit(function() {
    alert($('[name="multiprovinsi[]"]').val());
    return false;
  });